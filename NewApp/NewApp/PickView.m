...
//  StudyAbroad
//
//  Created by L on 15/7/3.
//  Copyright (c) 2015年 Studio. All rights reserved.
//
#define LToobarHeight 40
...
-(void)setFrameWith:(BOOL)isHaveNavControler{
    CGFloat toolViewX = 0;
    CGFloat toolViewH = _pickeviewHeight+LToobarHeight;
    CGFloat toolViewY ;
...
-(void)setUpPickView{
    ...
    pickView.frame=CGRectMake(0, LToobarHeight, pickView.frame.size.width, pickView.frame.size.height);
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.frame=CGRectMake(0, LToobarHeight, datePicker.frame.size.width, datePicker.frame.size.height);
...
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width, LToobarHeight);
}
...
-(void)doneClick
{
    if (_pickerView) {
        ...
        _resultString=[NSString stringWithFormat:@"%@",strDate];
    }
