...
- (instancetype)initWithTitle:(NSString *)title icon:(UIImage *)icon message:(NSString *)message delegate:(id<LAlertViewDelegate>)delegate buttonTitles:(NSString *)buttonTitles, ... {
    if (self = [super initWithFrame:[UIScreen mainScreen].bounds]) {
        _icon = icon;
        _title = title;
        _message = message;
...
- (void)initContentView {
    contentViewWidth = CURRENT_CONTENT_WIDTH - 90;
...
- (void)initTitleAndIcon {
    ...
    if (_title != nil && ![_title isEqualToString:@""]) {
        ...
        _titleLabel.textColor = RGBCOLOR(28, 28, 28);
...
- (void)initMessage {
    if (_message != nil) {
        ...
        _messageLabel.textColor = RGBCOLOR(120, 120, 120);
...
- (void)initAllButtons {
    if (_buttonTitleArray.count > 0) {
        ...
        horizonSperatorView.backgroundColor = RGBCOLOR(218, 218, 222);
        ...
        for (NSString *buttonTitle in _buttonTitleArray) {
            ...
            [button setTitleColor:RGBCOLOR(70, 130, 180)forState:UIControlStateNormal];
            ...
            if (index < _buttonTitleArray.count - 1) {
                ...
                verticalSeperatorView.backgroundColor = RGBCOLOR(218, 218, 222);
