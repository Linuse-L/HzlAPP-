...
- (void)createToolbar
{
    ...
    _saveImageBtn.frame = CGRectMake(0, 10, 64, 64);
    _saveImageBtn.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    [_saveImageBtn setImage:[UIImage imageNamed:@"deleteBt"] forState:UIControlStateNormal];
    [_saveImageBtn setImage:[UIImage imageNamed:@"deleteBt"] forState:UIControlStateHighlighted];
